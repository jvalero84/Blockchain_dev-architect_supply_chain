...
contract SupplyChain is Ownable, DistributorRole, ConsumerRole, RetailerRole, FarmerRole {
  ...
  // Define a modifer that checks to see if msg.sender == owner of the contract (inherited from Ownable.sol
  ...
  modifier paidEnough(uint _price) {
    require(msg.value >= _price, 'There is not enough funds');
    _;
  }
  ...
  constructor() public payable {
    //owner = msg.sender; This should be done when the parent constructor is called.
    sku = 1;
    //upc = 1;
  }
  ...
  function harvestItem(uint _upc, address _originFarmerID, string _originFarmName, string _originFarmInformation, string  _originFarmLatitude, string  _originFarmLongitude, string  _productNotes) public onlyFarmer
  {
    ...
    Item memory item = Item({
      ...
      productID: _upc + sku, // TODO: Concatenate as strings.. uint(abi.encodePacked(_upc,sku)),
  ...
  itemState = uint(currentItem.itemState),
